...
public class AccountSteps {
	...
	public void i_am_on_user_regristration_page() {
		System.out.println("================");
		System.out.println("I navigation to user caretion page using selenium");
	}
	
	@When ("I enter {string} in username field")
	public void i_enter_in_username_field(String uName) {
		System.out.println("=================");
	...
	public void i_enter_in_age_field(String age) {
		System.out.println("=================");
		System.out.println("Entered Username:" + age);}
	
	@When ("I enter {string} in gender field")
	public void i_enter_in_gender_field(String gender) {
		System.out.println("=================");
		System.out.println("Entered Username:" + gender);}
	
	@When ("I enter create account button")
	public void i_enter_create_account_button() {
		System.out.println("=================");
